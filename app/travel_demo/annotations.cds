using TravelService as service from '../../srv/travel_service';
...
annotate service.Travel with @(
    UI : {
      ...
      Identification : [
        { $Type  : 'UI.DataFieldForAction', Action : 'service.acceptTravel',   Label  : '{i18n>AcceptTravel}'   },
        { $Type  : 'UI.DataFieldForAction', Action : 'service.rejectTravel',   Label  : '{i18n>RejectTravel}'   },
        { $Type  : 'UI.DataFieldForAction', Action : 'service.deductDiscount', Label  : '{i18n>DeductDiscount}' }
      ],
      HeaderInfo : {
...
annotate service.BookingSupplement with @UI : {
  Identification : [
...
annotate service.Flight with @UI : {
